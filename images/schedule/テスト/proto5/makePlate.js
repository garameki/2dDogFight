...
var makePlate=function(title,hour,minute,xx,yy){
	...
	var eleHour=makeCanvas(hour,ClassHour,Relative,0,0,32,height,'green',30,'left');
	eleHour.__number=0;
	...
	var eleMinute=makeCanvas(minute,ClassMinute,Relative,0,0,30,height,'green',30,'left');
