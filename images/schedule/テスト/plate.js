//ファイルの関係性関連
plateJS=null;
FR.push(new FileRelative("modalWindowInput2JS","plateJS"));
FR.push(new FileRelative("modalWindowYesNoJS","plateJS"));
...
//modalWindowは答えだけ返す
			...
			if(gAnsModalWindowYesNo!=null){
				gAnsModalWindowYesNo=null;
				mwYesNo("消してもいいですか?");
