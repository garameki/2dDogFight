var filename='modalWindowInput3JS';
var script=(function(){/*
	__FILENAME__=null;


	FR.push(new FileRelative('libraryJS','__FILENAME__'));//inherits()
	FR.push(new FileRelative('classModalWindowJS','__FILENAME__'));//super class
...
mwYesNo.setMessage("値を入力してください");
mwInput.appear(event.clientX,event.clientY);
