...
//console.log("event.currentTarget=",event.currentTarget.children[0].getElementsByClassName(ClassTitle)[0].__title);
//console.log("event.target=",event.target.__title);
