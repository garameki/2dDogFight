...
const FilenameWeight = 'C:\\Users\\usaku\\Documents\\games\\2dDogFight\\AI\\Ver3\\ai3weight.txt';
...
var gCount=0;
var hogeReadWeight = setTimeout(function(){
	gCount++;
	if(gCount>30)clearTimeout(hogeReadWeight);
	if('ai3_readWeight' in window){
		ai3_readWeight();
		flagReadWeightStop=true;
	};
	if(flagReadWeightStop || flagStop)clearTimeout(hogeReadWeight);
},100);

};
////////////////////////////////////////////////////////////////////////////

var ai3_readWeight = function(){
	//ファイルのweightを読み込む
...
console.log("fs=",fs);
	...
	console.info("read weight from file !");
};


var ai3_writeWeight = function(){
	//ファイルにweightを書き込む
if(true){
	var fs = new ActiveXObject("Scripting.FileSystemObject");
	var ForReading = 1;
	...
	console.info("wrote Weights into file !");
}else{
	console.error("did not write weight into file ");
};//true/false
...
console.log("ai3_globalVariables.js   ready");
