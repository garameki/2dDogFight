...
var Weight30 = function(){//●復活
//○var Weight30 = function(filename){
...
//●ここから
Weight30.prototype.setFilename = function(name){
	this.filename =name;
	this.readWeight();
};
//●ここまで
...
Weight30.prototype.decode = function(number){
...
//○Weight30.prototype.filename="";//weightがしまってあるファイル名//○コンストラクタに移動
...
Weight30.prototype.flagWritten=false;//少し前に書き込みがあったらtrue
Weight30.prototype.writeWeight = function(){
	...
	if(!this.flagWritten){
		...
		info.text("writeWeight n="+(count-1).toString());
		info.text(this._name+".writeWeightwrote() was executed.");
	}else{
...
console.log("aiGlobalVariables5_1.js   ready");
