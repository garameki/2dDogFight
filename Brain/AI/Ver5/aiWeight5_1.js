...
//○Weight30.prototype._filename='';//ファイル名
//○Weight30.prototype.setFilenameWeight = function(name){
//○	this._filename=name
//○};
Weight30.prototype.filename="";//●weightがしまってあるファイル名
...
//○		var file = fs.OpenTextFile(this.filename,ForWriting.toString(16),true);//trueでファイルがないとき新規作成
		for(var ii=0;ii<this.weight11.length;ii++){
			for(var kk=0;kk<this.weight11[ii].length;kk++){
