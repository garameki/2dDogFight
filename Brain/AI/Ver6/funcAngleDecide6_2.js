...
//古い経験ほどp値を1/x^2にした。のをやめた。


//マイナーマイナーチェンジは交換可能。値を変えただけ、またはアルゴリズムを変えただけ

		//  ●  決定(角度)
var AngleDecide6_2 = function(){
	this.nameAngleDecide='AngleDecide6_2';
	this.progressAngleDecide='+1 -1。1/NSpan^2。';
...
console.log("funcAngleDecide6_2.js");
