...
__progressAI__='+1 -1。1/NSpan^2で学習。';
...
if(!$test){
	__pathparts__='../Brain/AI/Ver6/';//action.html基準
}else{
	__pathparts__='../../Brain/AI/Ver6/';//../../Plane/AI/htmHeaderTest.html基準
//	__pathparts__='./';//./htmHeaderTest.html基準
};
...
__versionInputStore__	='6_1';
__versionAngleDecide__	='6_2';//●
__versionAngleLearn__	='6_1';//●
...
var headerAI__version__ = function(){
	...
	var hoge = setInterval(function(){
		...
		if(con){
			...
			AI__version__.prototype.nameAI='AI__version__';
			AI__version__.prototype.progressAI='__progressAI__';//●
			...
			console.info("'AI__version__'が使えます！");
...
script=script.replace(/__progressAI__/g,__progressAI__);
