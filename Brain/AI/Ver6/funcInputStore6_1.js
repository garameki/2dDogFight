		...
		//  ●  入力層へ入力
var InputStore6_1 = function(){
	this.nameInputStore='InputStore6_1';
	this.progressInputStore='preInput[]を採用して、同じ入力をさせないようにしてみた。→やめた';
...
//console.info("funcInputStore5_1.js      ready!");
