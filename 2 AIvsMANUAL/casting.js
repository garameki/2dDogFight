...
//	var myb=new BeamAuto2('mybeam','fighter');
	var myb = new BeamAuto2_0('mybeam','fighter');

//	var aa = new PlaneAI5_0('fighter','mybeam','enemy',pointOfView,AI5_0);
//	var myb = new BeamAI2_0('mybeam','fighter');


	var enemy = new PlaneAI5_0('enemy','yanbeam','fighter',pointOfView,AI5_0);
