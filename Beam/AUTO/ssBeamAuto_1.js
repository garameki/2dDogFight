...
var BeamAutoVer1 = function(sName,sNamePlane){
...
inherits(BeamAutoVer1,SpriteF);
BeamAutoVer1.prototype.play = function() {
...
//console.log("angle=",dAngle);
		...
		if(Math.abs(dAngle)<30 && myPlane.state==1 && target.state==1)flagFire=true;
		if(flagFire){
			if(myself.state==1){
