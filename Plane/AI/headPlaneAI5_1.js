...
//○	names.push('ssPlaneAI5_0.js');
	...
	var hoge = setInterval(function(){
		...
		if('PlaneAI__versionPlane__' in window){
			PlaneAI__versionPlane__.prototype.procMotion=PlaneAIMotion__versionMotion__;//各ファイルの中の関数名を使います
			PlaneAI__versionPlane__.prototype.procCollision=PlaneAIEvaluateCollision__versionCollision__;//●Ver0を無くした
			...
			clearInterval(hoge);
			console.info("headerPlaneAI__versionHead__ の準備が出来ました。 !");
			console.info("'PlaneAI__versionPlane__'が生成されました。");
		};
	},100);
