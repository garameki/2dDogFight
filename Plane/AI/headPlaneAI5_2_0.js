...
console.info("headPlaneAI"+__version__+".js   start");


__versionPlaneSuper__='5_2';
...
var headerPlaneAI__version__ = function(){
	...
	names.push('printStatus__versionStatus__.js');//●
	names.push('ssPlaneAI__versionPlaneSuper__.js');//●
	...
	var hoge = setInterval(function(){
		...
		if('PlaneAI__versionPlaneSuper__' in window){
			...
			PlaneAI__version__.prototype.procPrintStatus=PlaneAIPrintStatus__versionStatus__;//●
...
console.info("headPlaneAI"+__version__+".js   ready");
