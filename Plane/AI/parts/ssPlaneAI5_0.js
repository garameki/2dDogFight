console.info("eval ssPlaneAI5_0.js");
...
var PlaneAI__version__ = function(sName,sNameBeam,sNameTarget,sNameCenter,classAI){
...
if(this.flagStopPlay){
	...
	var ai = new this.classAI(myself,target);//AI乗せ換えられるようにした
...
var file = fs.OpenTextFile("C:\\Users\\usaku\\Documents\\games\\2dDogFight\\Plane\\AI\\parts\\recognizePlane.txt",ForWriting.toString(16),true);//trueでファイルがないとき新規作成
