var EvaluateCollision6_0 = function(myself){
	var myself=myself;
	var myBeam=myself.beam;
	var target=myself.target;
	var yanBeam=target.beam;

//console.log("procEvaluateCollision6_0.js       myself=",myself," myBeam=",myBeam," target=",target," yanBeam=",yanBeam);
...
//console.log("procEvaluateCollision6_0.js       myself="+myself._name);
//console.log("procEvaluateCollision6_0.js       myBeam="+myBeam._name);
//console.log("procEvaluateCollision6_0.js       target="+target._name);
//console.log("procEvaluateCollision6_0.js       yanBeam="+yanBeam._name);
//console.log("procEvaluateCollision6_0.js       myself="+myself._name+" myBeam="+myBeam._name+" target="+target._name+" yanBeam="+yanBeam._name);
